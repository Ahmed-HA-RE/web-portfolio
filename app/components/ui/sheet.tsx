      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot='sheet-close' asChild>
            <Button
              variant='ghost'
              className='absolute top-8 right-8 cursor-pointer hover:bg-0 text-primary hover:text-primary/90'
              size='icon-sm'
            >
